...
import {Platform, StyleSheet, Text, View,AsyncStorage, TouchableOpacity, TextInput, Modal, FlatList} from 'react-native';
          ...
          <View style={styles.subContainerView}>
           <View style={[styles.container,{flexDirection:'row'}]}>
            ...
            <TouchableOpacity onPress={this.openModal}>
              ...
              <View style={[styles.rightBorderView,{borderColor:phoneNumber.length === 0 ?'grey':phoneNumber.length != 11 ? 'red':'grey'}]}>
              <TextInput                     
                      style={[styles.textStyle,{color:phoneNumber.length != 11 ? 'red':'black'}]} 
                      value={phoneNumber}
...
const styles = StyleSheet.create({
  ...
  rowStyle:{height:30, borderBottomWidth:1, borderColor:'grey', alignItems:'center', justifyContent:'center'},
  rowText:{fontWeight:16, fontWeight:'700', color:'black'},
  modalContainerStyle:{flex:1, backgroundColor:'#24292e6b', alignItems:'center', justifyContent:'center'},
  modalSubContainer:{height:'auto', width:300, backgroundColor:'white', borderRadius:10},
  closeButtonView:{height:30, width:100, backgroundColor:'black', alignSelf:'center', alignItems:'center', justifyContent:'center', borderRadius:5, marginBottom:10},
